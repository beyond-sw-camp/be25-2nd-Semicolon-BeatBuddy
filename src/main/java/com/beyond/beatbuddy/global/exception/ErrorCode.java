...
public enum ErrorCode {
    ...
    GROUP_NICKNAME_REQUIRED(HttpStatus.BAD_REQUEST, "그룹 닉네임을 입력해주세요."),
    GROUP_MEMBER_NOT_FOUND(HttpStatus.NOT_FOUND, "해당 그룹에 소속되어 있지 않습니다."),
    DUPLICATE_GROUP_NICKNAME(HttpStatus.CONFLICT, "이미 사용 중인 그룹 닉네임입니다."),
